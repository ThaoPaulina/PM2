...
public class VideospielTest
{
	...
	{
		assertFalse("Mehrere Exemplare des gleichen Videospiels sind ungleich", _vs1.equals(_vs2));
		assertTrue("Dasselbe Exemplare des gleichen Videospiels ist gleich", _vs1.equals(_vs1));
	}
