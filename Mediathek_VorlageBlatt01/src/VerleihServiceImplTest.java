...
public class VerleihServiceImplTest
{
    ...
    {
    	assertTrue(_verleihService.istVerleihenMoeglich(_brian,_medienbestand.getMedien()));
    	_verleihService.verleiheAn(_brian, _medienbestand.getMedien(),Datum.heute());
    	assertFalse(_verleihService.istVerleihenMoeglich(_brian, _medienbestand.getMedien()));
    ...
    {
     	assertTrue(_verleihService.istVerleihenMoeglich(_roger,_medienbestand.getMedien()));
    	_verleihService.verleiheAn(_roger, _medienbestand.getMedien(),Datum.heute());
    	assertFalse(_verleihService.istVerleihenMoeglich(_roger, _medienbestand.getMedien()));
